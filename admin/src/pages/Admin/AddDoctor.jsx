      ...
      const { data } = await axios.post(
        ...
        formData,
        {
          headers: {
            ...
            aToken, // just in case your backend uses custom headers
  ...
  return (
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
            ...
            <img
              ...
              src={
                docImg
                  ...
                  : "https://www.shutterstock.com/image-vector/add-profile-picture-icon-vector-260nw-2259938503.jpg"
              }
              alt="Upload"
              height={100}
              width={100}
        ...
        <button type='submit' className='bg-primary px-10 py-3 mt-4 text-black rounded-full'>Add Doctor</button>
      </div>
    </form>
  );
};
